...
public abstract class MenuUtils {
	...
	public static boolean handleSingleSelectionAction(
		...
		if (id == R.id.menu_open) {
			...
			return true;
		} else if (id == R.id.menu_create_shortcut) {
			createShortcut(fItem, context);
			return true;
		} else if (id == R.id.menu_move) {
			CopyHelper.get(navigator.getActivity()).cut(fItem);
			navigator.updateClipboardInfo();
			...
			CopyHelper.get(navigator.getActivity()).copy(fItem);
			navigator.updateClipboardInfo();
